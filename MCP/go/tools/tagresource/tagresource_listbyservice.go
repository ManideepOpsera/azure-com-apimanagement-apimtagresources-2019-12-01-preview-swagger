...
func Tagresource_listbyserviceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/subscriptions/%s/resourceGroups/%s/providers/Microsoft.ApiManagement/service/%s/tagResources%s", cfg.BaseURL, resourceGroupName, serviceName, subscriptionId, queryString)
...
func CreateTagresource_listbyserviceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft_ApiManagement_service_serviceName_tagResources",
		mcp.WithDescription("Lists a collection of resources associated with tags."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Tagresource_listbyserviceHandler(cfg),
	}
}
